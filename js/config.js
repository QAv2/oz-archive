...
export const EXHIBITS = [
  ...
  },
  {
    ...
    description: '9 terminal and GUI games built in Python — from Tic-Tac-Toe to a Myst-style adventure engine. Collaborative teaching project with a 13-year-old nephew.',
    url: null,
    action: 'overlay',
    texture: 'textures/exhibit-games.png',
    lightColor: 0xff8800,
    lightColorCSS: '#ff8800',
    type: 'arcade',
  },
];
